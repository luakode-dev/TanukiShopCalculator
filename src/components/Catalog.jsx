...
export default function Catalog({ navigateToSection }) {
    ...
    const editProduct = (product) => {
        try {
            localStorage.setItem('tanuki_product_to_edit', JSON.stringify(product))
            navigateToSection('calculator')
        } catch (e) {
            console.error('Error preparing product for edit:', e)
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <div className="flex items-center justify-center space-x-2">
                                                <button
                                                    ...
                                                    className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-600 hover:text-blue-700 transition-all duration-200 hover:scale-110"
